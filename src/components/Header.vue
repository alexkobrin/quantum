        ...
        <div class="header__search-input-wrapper">
          <div class="input-field inline">
            <input
              ...
              :class="{
                invalid: ($v.searchProduct.$dirty && $v.searchProduct.minLength.$invalid) || ($v.searchProduct.$dirty && $v.searchProduct.$model === ''),
              }"
            />

            <span class="helper-text" v-if="$v.searchProduct.$dirty && $v.searchProduct.$model === ''"> Field should not be empty </span>
            <span class="helper-text" v-else-if="$v.searchProduct.$dirty && $v.searchProduct.minLength.$invalid"> Request must contain at least 5 symbols. </span>
          </div>
        </div>
        <a class="dropdown-trigger waves-effect waves-blue lighten-4" ref="dropdown" href="#" data-target="dropdown1">{{ dropdownSelected }} <i class="material-icons">arrow_drop_down</i></a>
        <ul id="dropdown1" class="dropdown-content">
          <li>
            <a href="#!" @click="selected" data="Mobile"> <i class="material-icons">call</i>Mobile</a>
          </li>
          <li>
            <a href="#!" @click="selected" data="Tablet" ref="Tablet"> <i class="material-icons">devices</i>Tablet</a>
          </li>
          <li>
            <a href="#!" @click="selected" data="Laptop"><i class="material-icons">view_module</i>Laptop</a>
          </li>
        </ul>
        ...
        <a href="#" class="header-link">
          <span class="header-link__icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewbox="0 0 16 16">
              <path d="M16 13v3H0v-3c0-2.66 5.33-4 8-4s8 1.34 8 4zm-4.002-9c0 2.21-1.789 4-3.998 4a3.997 3.997 0 0 1-4-4c0-2.21 1.788-4 4-4 2.21 0 3.998 1.79 3.998 4zm-10.1 9v1.1H14.1V13c0-.64-3.13-2.1-6.1-2.1-2.968 0-6.1 1.46-6.1 2.1zM5.9 4a2.101 2.101 0 0 0 4.202 0A2.101 2.101 0 0 0 5.9 4z" />
            </svg>
          </span>
        ...
        <div class="header-nav__select">
          ...
          <div class="header-nav__select-item">
            <div class="nav-dropdown">
              ...
              <div class="nav-dropdown__dropdown">
                <a href="#" @click="selectedCurrency" class="nav-dropdown__dropdown-item">RUR</a>
                <a href="#" @click="selectedCurrency" class="nav-dropdown__dropdown-item">UAN</a>
                <a href="#" @click="selectedCurrency" class="nav-dropdown__dropdown-item">USD</a>
              </div>
            </div>
          </div>
          <!-- // item -->
          ...
          <div class="header-nav__select-item">
            <div class="nav-dropdown">
              ...
              <div class="nav-dropdown__dropdown">
                <a href="#" @click="selectedLanguages" class="nav-dropdown__dropdown-item">English</a>
                <a href="#" @click="selectedLanguages" class="nav-dropdown__dropdown-item">Russian</a>
                <a href="#" @click="selectedLanguages" class="nav-dropdown__dropdown-item">Polish</a>
              </div>
            </div>
          </div>
          <!-- // item -->
