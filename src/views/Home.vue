  ...
  <div class="home">
    <header class="header">
      <div class="header__container">
        ...
        <form @submit.prevent="submitHandler" class="header__search">
          <div class="header__search-input-wrapper">
            <div class="input-field inline">
              <input
                ...
                :class="{invalid: $v.searchProduct.$dirty && !$v.searchProduct.minLength }"
          ...
          <ul id="dropdown1" class="dropdown-content">
            <li>
              <a href="#!" @click="selected" data="Mobile">
                <i class="material-icons">call</i>Mobile</a
              >
            </li>
            <li>
              <a href="#!" @click="selected" data="Tablet" ref="Tablet">
                <i class="material-icons">devices</i>Tablet</a
              >
            </li>
            <li>
              <a href="#!" @click="selected" data="Laptop"
                ><i class="material-icons">view_module</i>Laptop</a
              >
            </li>
          </ul>
            ...
            <a href="#" class="header-mega-menu-link">
              <span class="header-mega-menu-link__icon"
                ><svg
                  ...
                  viewbox="0 0 18 12"
                >
                  <path d="M18 0v2H0V0zM0 5h18v2H0zm0 5h18v2H0z" /></svg
              ></span>
    ...
    <section class="banner-section">
      <div class="container">
        <div class="banner-section__inner"></div>
      </div>
    </section>
            ...
            <a href="" class="promo-section-item-link-wrapper">
              <div class="promo-section-item">
                ...
                <img
                  ...
                  src="../assets/img/promo/headphones.jpg"
                  alt="headphones"
                />
              </div>
            </a>
                ...
                <li class="navigation__item">
                  ...
                  <div class="navigation__item-arrow">
                    <svg
                      ...
                      viewbox="0 0 6 10"
                    >
                      <path d="M6.001 5.002L2.999 0H.126l3.018 5.002L0 10h3z" />
                    </svg>
                  </div>
                </li>
                <li class="navigation__item">
          ...
          <div class="main__column-right">
            ...
            <div class="cards-wrapper">
              ...
              <div class="card">
                ...
                <div class="card__img">
                  <img
                    src="../assets/img/phones/phone1.png"
              ...
              <div class="card">
                ...
                <div class="card__img">
                  <img
                    src="../assets/img/phones/phone2.png"
                    alt="Asus ZenFone Go ZB452KG (black and white)"
                  />
                </div>
                <h4 class="card__title">
              ...
              <div class="card">
                ...
                <div class="card__img">
                  <img
                    src="../assets/img/phones/phone3.png"
                    alt="Asus ZenFone Go ZB452KG (black and white)"
                  />
                </div>
                <h4 class="card__title">
              ...
              <div class="card">
                ...
                <div class="card__img">
                  <img
                    src="../assets/img/phones/phone4.png"
                    alt="Asus ZenFone Go ZB452KG (black and white)"
                  />
                </div>
                <h4 class="card__title">
              ...
              <div class="card">
                ...
                <div class="card__img">
                  <img
                    src="../assets/img/phones/phone5.png"
                    alt="Asus ZenFone Go ZB452KG (black and white)"
                  />
                </div>
                <h4 class="card__title">
              ...
              <div class="card">
                ...
                <div class="card__img">
                  <img
                    src="../assets/img/phones/phone6.png"
                    alt="Asus ZenFone Go ZB452KG (black and white)"
                  />
                </div>
                <h4 class="card__title">
              ...
              <nav class="nav-footer">
                <ul class="nav-footer__list">
                  <li class="nav-footer__list-item">
                    <a
                      class="nav-footer__link nav-footer__link--dropdown"
                      href="#"
                    >
                      Shop
                      <span>
                  ...
                  <li class="nav-footer__list-item">
                    <a class="nav-footer__link" href="#">Journal</a>
                  </li>
                  <li class="nav-footer__list-item">
                    <a class="nav-footer__link" href="#">About</a>
                  </li>
                  <li class="nav-footer__list-item">
                    <a class="nav-footer__link" href="#">Contacts</a>
                  </li>
                </ul>
              </nav>
            </div>
            <div class="footer__socials">
              <div class="social">
                ...
                <a href="#" class="social__item">
                  ...
                  >
                    <path
                      d="M6 9.26V2.73L12 6zM16 2c0-1.1-.9-2-2-2H2C.9 0 0 .9 0 2v8c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2z"
                    />
                  </svg>
                </a>
              </div>
            ...
            <div class="payments">
              ...
              <div class="payments__icons">
                <a class="payments__icon" href="#">
                  <img
                    src="../assets/img/payment/amazon_icon.png"
                    alt="Amazon"
                  />
                </a>
                <a class="payments__icon" href="#">
                  <img
                    src="../assets/img/payment/pay_pal_icon.png"
                    alt="PayPal"
                  />
                </a>
                <a class="payments__icon" href="#">
                  <img
                    src="../assets/img/payment/master_сard.png"
                    alt="MasterCard"
                  />
                </a>
                <a class="payments__icon" href="#">
