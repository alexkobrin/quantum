        ...
        <div class="header__container">
            ...
            <form class="header__search">
                <div class="header__search-input-wrapper">
                    <input class="header__search-input" type="text" placeholder="Search goods">
                </div>
                <div class="header__search-dropdown">

                    <div data-select class="header-select">
                        <div data-select-title class="header-select__title">CATEGORY</div>
                        <div class="header-select__dropdown hidden">
                            <div data-select-item="mobile" class="header-select__dropdown-item">Mobile</div>
                            <div data-select-item="tablet" class="header-select__dropdown-item">Tablet</div>
                            <div data-select-item="laptop" class="header-select__dropdown-item">Laptop</div>
                        </div>
                    </div>
            ...
            <div class="header-nav">
                <div class="header-nav__categories">
                    <a href="#" class="header-mega-menu-link">
                        <span class="header-mega-menu-link__icon"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                                height="12" viewbox="0 0 18 12">
                                <path d="M18 0v2H0V0zM0 5h18v2H0zm0 5h18v2H0z" />
                            </svg></span>
                        <span class="header-mega-menu-link__text">All Categories</span>
                    </a>
                </div>
                ...
                <div class="header-nav__select">
                            ...
                            <a href="#" class="nav-dropdown__title">
                                ...
                                <div class="nav-dropdown__title-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="5" viewbox="0 0 8 5">
                                        <path d="M3.998 5L8 2.5V.104L3.998 2.62 0 0v2.5z" />
                                    </svg>
                                </div>

                            </a>
                            <div class="nav-dropdown__dropdown">
                                <a href="#" class="nav-dropdown__dropdown-item">F.A.Q.</a>
                                <a href="#" class="nav-dropdown__dropdown-item">Payment</a>
                                <a href="#" class="nav-dropdown__dropdown-item">Delivery</a>
                            </div>
                        </div>
                        <!-- // dropdown nav -->
                    ...
                    <div class="header-nav__select-item">
                        ...
                        <div class="nav-dropdown">
                            ...
                            <div class="nav-dropdown__dropdown">
                                <a href="#" class="nav-dropdown__dropdown-item">RUR</a>
                                <a href="#" class="nav-dropdown__dropdown-item">UAN</a>
                                <a href="#" class="nav-dropdown__dropdown-item">USD</a>
                            </div>
                        </div>
                    ...
                    <div class="header-nav__select-item">
                        ...
                        <div class="nav-dropdown">
                            ...
                            <div class="nav-dropdown__dropdown">
                                <a href="#" class="nav-dropdown__dropdown-item">English</a>
                                <a href="#" class="nav-dropdown__dropdown-item">Russian</a>
                                <a href="#" class="nav-dropdown__dropdown-item">Polish</a>
                            </div>
                        </div>
          ...
          <div class="banner-section__inner">
            <div class="banner-section__slider">
              <a class="banner-section__slider-item" href="#">
                <h2 class="banner-section__slider-title">The Universe Through A Child S Eyes</h2>
                <div class="banner-section__slider-text">Start sales! Start sales! Start sales!</div>
                <img class="banner-section__slider-img" src="img/carousel/slide-01.jpg" alt="">
              </a>
              <a class="banner-section__slider-item" href="#">
                <h2 class="banner-section__slider-title">The Basics Of Buying A Telescope</h2>
                <div class="banner-section__slider-text">Start sales! Start sales! Start sales!</div>
                <img class="banner-section__slider-img" src="img/carousel/slide-01.jpg" alt="">
              </a>
              <a class="banner-section__slider-item" href="#">
            ...
            <div class="promo-section__row">
                <div class="promo-section__col">
                    ...
                    <a href="" class="promo-section-item-link-wrapper">
                        <div class="promo-section-item">
                            ...
                            <img class="promo-section-item__img" src="../assets/img/promo/headphones.jpg" alt="headphones">
                        </div>
                    </a>
                    <!-- // item -->
                </div>
                ...
                <div class="promo-section__col">
                    <a href="" class="promo-section-item-link-wrapper promo-section-item-link-wrapper--column">
                        <div class="promo-section-item promo-section-item--small">
                            <div class="promo-section-item__img-cell">
                                <img src="../assets/img/promo/pencil.jpg" alt="">
                            </div>
                    ...
                    <a href="" class="promo-section-item-link-wrapper promo-section-item-link-wrapper--column">
                        <div class="promo-section-item promo-section-item--small">
                            <div class="promo-section-item__img-cell">
                                <img src="../assets/img/promo/whatch.jpg" alt="">
                            </div>
                            <div class="promo-section-item__title-cell">
                                <h4 class="promo-section-item__title">
                                    How Plasma Tvs And
                        ...
                        <ul class="navigation__list">
                            <li class="navigation__item">
                                <div class="navigation__item-icon">
                                    <svg class="navigation__icon" xmlns="http://www.w3.org/2000/svg" width="22"
                                ...
                                <div class="navigation__item-arrow">
                                    <svg class="navigation__icon-arrow" xmlns="http://www.w3.org/2000/svg" width="6"
                                        height="10" viewbox="0 0 6 10">
                                        <path d="M6.001 5.002L2.999 0H.126l3.018 5.002L0 10h3z" /></svg>
                                </div>
                            </li>
                            <li class="navigation__item">
                                <div class="navigation__item-icon">
                            ...
                            <li class="navigation__item">
                                <div class="navigation__item-icon">
                                    <svg class="navigation__icon" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="16" viewbox="0 0 24 16">
                                        <path
                                            d="M4.002 2H20v10H4.002zM20 14c1.1 0 1.989-.9 1.989-2l.01-10C22 .9 21.1 0 20 0H4.002C2.899 0 1.999.9 1.999 2v10c0 1.1.9 2 2.003 2H-.001v2h24.002v-2z" />
                                    </svg>
                                </div>
                                <div class="navigation__item-title">
                                    Laptops
                            ...
                            <li class="navigation__item">
                                <div class="navigation__item-icon">
                                    <svg class="navigation__icon" xmlns="http://www.w3.org/2000/svg" width="20"
                                        height="14" viewbox="0 0 20 14">
                                        <path
                                            d="M17 5h-2.002V3H17zm0 3h-2.002V6H17zm-3-3h-2V3h2zm0 3h-2V6h2zm0 4H6v-2h8zM5 5H3.002V3H5zm0 3H3.002V6H5zm1-2h2v2H6zm0-3h2v2H6zm3 3h2v2H9zm0-3h2v2H9zm9-3H1.999C.899 0 .01.9.01 2L.001 12c0 1.1.899 2 1.998 2h16c1.102 0 2-.9 2-2V2c0-1.1-.898-2-2-2z" />
                                    </svg>
                                </div>
                                <div class="navigation__item-title">
                                    Friends
                            ...
                            <li class="navigation__item">
                                <div class="navigation__item-icon">
                                    <svg class="navigation__icon" xmlns="http://www.w3.org/2000/svg" width="18"
                            ...
                            <li class="navigation__item">
                                <div class="navigation__item-icon">
                                    <svg class="navigation__icon" xmlns="http://www.w3.org/2000/svg" width="14"
                                        height="20" viewbox="0 0 14 20">
                                        <path
                            ...
                            <li class="navigation__item">
                                <div class="navigation__item-icon">
                                    <svg class="navigation__icon" xmlns="http://www.w3.org/2000/svg" width="13"
                            ...
                            <li class="navigation__item">
                                <div class="navigation__item-icon">
                                    <svg class="navigation__icon" xmlns="http://www.w3.org/2000/svg" width="22"
                                        ...
                                        <path
                                            d="M20 14H2V2h18zm0-14H2C.9 0 0 .9 0 2v12c0 1.1.9 2 2 2h5v2h8v-2h5c1.1 0 1.989-.9 1.989-2l.01-12C22 .9 21.1 0 20 0z" />
                                    </svg>
                                </div>
                                <div class="navigation__item-title">
                                    TV & Video
                            ...
                            <li class="navigation__item">
                                <div class="navigation__item-icon">
                                    <svg class="navigation__icon" xmlns="http://www.w3.org/2000/svg" width="22"
                                        ...
                                        <path
                                            d="M18.5 6a1.5 1.5 0 1 1 0-3c.83 0 1.5.67 1.5 1.5S19.33 6 18.5 6zm-4 3c-.832 0-1.5-.67-1.5-1.5S13.669 6 14.5 6c.83 0 1.498.67 1.498 1.5S15.33 9 14.499 9zM10 7H7v3H5V7H2V5h3V2h2v3h3zm10-7H2C.9 0 0 .9 0 2v8c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V2c0-1.1-.9-2-2-2z" />
                                    </svg>
                                </div>
                                <div class="navigation__item-title">
                                    Game consoles
                            ...
                            <li class="navigation__item">
                                <div class="navigation__item-icon">
                                    <svg class="navigation__icon" xmlns="http://www.w3.org/2000/svg" width="16"
                                        height="24" viewbox="0 0 16 24">
                                        <path
                ...
                <div class="main__column-right">
                    ...
                    <div class="cards-wrapper">
                        ...
                        <div class="card">
                            ...
                            <!-- // card__header -->
                            <div class="card__img">
                                <img src="../assets/img/phones/phone1.png" alt="Asus ZenFone Go ZB452KG (black and white)">
                            </div>
                            <h4 class="card__title">
                                Asus ZenFone Go ZB452KG (black and white)
                            </h4>
                            <div class="card__rating">
                                <img class="card__rating-star" src="../assets/img/icons/star_icon.svg" alt="">
                                <img class="card__rating-star" src="../assets/img/icons/star_icon.svg" alt="">
                                <img class="card__rating-star" src="../assets/img/icons/star_icon.svg" alt="">
                                <img class="card__rating-star" src="../assets/img/icons/star_half_icon.svg" alt="">
                                <img class="card__rating-star" src="../assets/img/icons/star_border_icon.svg" alt="">
                                <div class="card__rating-value">12</div>
                            </div>
                            <div class="card__footer">
                                <div class="card__price">$ 384.4</div>
                                <button class="card__cart"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                        ...
                        <div class="card">
                            ...
                            <!-- // card__header -->
                            <div class="card__img">
                                <img src="../assets/img/phones/phone2.png" alt="Asus ZenFone Go ZB452KG (black and white)">
                            </div>
                            <h4 class="card__title">
                                Asus ZenFone Go ZB452KG (black and white)
                            </h4>
                        ...
                        <div class="card">
                            ...
                            <!-- // card__header -->
                            <div class="card__img">
                                <img src="../assets/img/phones/phone3.png" alt="Asus ZenFone Go ZB452KG (black and white)">
                            </div>
                            <h4 class="card__title">
                                Asus ZenFone Go ZB452KG (black and white)
                            </h4>
                        ...
                        <div class="card">
                            ...
                            <!-- // card__header -->
                            <div class="card__img">
                                <img src="../assets/img/phones/phone4.png" alt="Asus ZenFone Go ZB452KG (black and white)">
                            </div>
                            <h4 class="card__title">
                                Asus ZenFone Go ZB452KG (black and white)
                            </h4>
                        ...
                        <div class="card">
                            ...
                            <!-- // card__header -->
                            <div class="card__img">
                                <img src="../assets/img/phones/phone5.png" alt="Asus ZenFone Go ZB452KG (black and white)">
                            </div>
                            <h4 class="card__title">
                                Asus ZenFone Go ZB452KG (black and white)
                            </h4>
                        ...
                        <div class="card">
                            ...
                            <!-- // card__header -->
                            <div class="card__img">
                                <img src="../assets/img/phones/phone6.png" alt="Asus ZenFone Go ZB452KG (black and white)">
                            </div>
                            <h4 class="card__title">
                                Asus ZenFone Go ZB452KG (black and white)
                            </h4>
                        ...
                        <nav class="nav-footer">
                            <ul class="nav-footer__list">
                                <li class="nav-footer__list-item">
                                    <a class="nav-footer__link nav-footer__link--dropdown" href="#">
                                        Shop
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="5" viewbox="0 0 8 5">
                                                <path d="M3.998 5L8 2.5V.104L3.998 2.62 0 0v2.5z" />
                                ...
                                <li class="nav-footer__list-item">
                                    <a class="nav-footer__link" href="#">Journal</a></li>
                                <li class="nav-footer__list-item">
                                    <a class="nav-footer__link" href="#">About</a></li>
                                <li class="nav-footer__list-item">
                                    <a class="nav-footer__link" href="#">Contacts</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="footer__socials">
                        <div class="social">
                            <a href="#" class="social__item">
                                <svg width="11" height="20" viewox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M11 0H8C5.23858 0 3 2.23858 3 5V8H0V12H3V20H7V12H10L11 8H7V5C7 4.44772 7.44772 4 8 4H11V0Z" />
                                </svg>
                            </a>
                            <a href="#" class="social__item">
                                <svg width="20" height="17" viewbox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M20 0.00932958C19.1294 0.6234 18.1656 1.09307 17.1455 1.40024C16.024 0.110728 14.2167 -0.341476 12.6201 0.267924C11.0234 0.877323 9.97709 2.41869 10 4.12751V5.0366C6.75515 5.12074 3.68366 3.57476 1.81818 0.91842C1.81818 0.91842 -1.81818 9.10024 6.36364 12.7366C4.49139 14.0075 2.26105 14.6447 0 14.5548C8.18182 19.1002 18.1818 14.5548 18.1818 4.10024C18.181 3.84701 18.1566 3.59442 18.1091 3.34569C19.0369 2.43069 19.6917 1.27543 20 0.00932958Z" />
                                </svg>
                            </a>
                            <a href="#" class="social__item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewbox="0 0 16 12">
                                    <path d="M6 9.26V2.73L12 6zM16 2c0-1.1-.9-2-2-2H2C.9 0 0 .9 0 2v8c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2z" />
                                </svg>
                            </a>
                        </div>
                    </div>
                ...
                <div class="footer__payment">
                    <div class="payments">
                        ...
                        <div class="payments__icons">
                            <a class="payments__icon" href="#">
                                <img src="../assets/img/payment/amazon_icon.png" alt="Amazon">
                            </a>
                            <a class="payments__icon" href="#">
                                <img src="../assets/img/payment/pay_pal_icon.png" alt="PayPal">
                            </a>
                            <a class="payments__icon" href="#">
                                <img src="../assets/img/payment/master_сard.png" alt="MasterCard">
                            </a>
                            <a class="payments__icon" href="#">
                                <img src="../assets/img/payment/visa_icon.png" alt="Visa">
                            </a>
                        </div>
                    </div>
                </div>
